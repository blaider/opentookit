// #############################################################################
// *****************************************************************************
//                  Copyright (c) 2017, Advantech Automation Corp.
		    ...
		    char *	ifname)
{
  ...
  scanopt.essid_len = strlen("WebAccess");
  memcpy(scanopt.essid, "WebAccess", scanopt.essid_len);
...
int get_system_wlan0_bitrate()
{
	...
	print_scanning_info(skfd,ifname);
	iw_sockets_close(skfd);
	return 0;
}
int main()
{
	get_system_wlan0_bitrate();
}
